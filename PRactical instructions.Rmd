---
title: "Practical simulation of social evolution under massal selection - 2024 ELLS summer school Darwinian agriculture"
author: "J David"
date: "2024-06-20"
output:
...
The phenotypic value (\(P\)) of an individual can be decomposed into multiple components:
\[ P = G + E \]
Where:
- **\(G\)** represents the genetic contribution to the phenotype.
- **\(E\)** represents the environmental contribution to the phenotype.

When considering the direct genetic effect (DGE) and the indirect genetic effect (IGE) from neighboring individuals, the model becomes:
\[ P = DGE + IGE + E_DGE + E_IGE\]
Where:
...
- **E_DGE**  (environment effect on Direct Genetic Effect)
- **E_IGE**  (environment effect on Indirect Genetic Effect)
